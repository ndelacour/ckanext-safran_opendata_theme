...
def is_datarequests_enabled():
    return "datarequests" in config.get('ckan.plugins', True)
...
class SafranOpendataThemePlugin(plugins.SingletonPlugin):
    ...
    def update_config(self, config_):
        ...
        #toolkit.add_resource('fanstatic', 'safran_opendata_theme')
        toolkit.add_resource('assets', 'safran_opendata_theme')
